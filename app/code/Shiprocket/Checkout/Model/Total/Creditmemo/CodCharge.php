...
class CodCharge extends Discount
{
    ...
    public function collect(
        ...
        $codCharge = $creditmemo->getOrder()->getFastrrCodCharge();

        $creditmemo->setFastrrCodCharge($codCharge);
        $creditmemo->setBaseFastrrCodCharge($codCharge);
        $creditmemo->setGrandTotal($creditmemo->getGrandTotal() + $creditmemo->getFastrrCodCharge());
        $creditmemo->setBaseGrandTotal($creditmemo->getBaseGrandTotal() + $creditmemo->getBaseFastrrCodCharge());
